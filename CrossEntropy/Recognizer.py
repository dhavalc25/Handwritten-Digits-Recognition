...
class Recognizer:
    ...
    def stochasticGradientDescent(self, trainSet, testSet, tries, learningRate, batchSize):
        """
        Using Stochastic gradient descent to obtain the best weights and biases for the given training set
        ...
        for j in range(tries):
            ...
            for batch in batches:
                # Creating empty matrices to store the calculated bias and weight values
                ...
                for input, output in batch:
                    ...
                    # Adding the change to the biases and weights over iterations.
                ...
                self.weights = [wgt - (learningRate / len(batch)) * nweight
...
class DataLoader:
    ...
    def loadData(self):
        ...
        # Vectorising the pixel data to a 784 x 1 matrix
        trainInputs = [numpy.reshape(x, (784, 1)) for x in train[0]]
        # Vectorising the expected output value to a 10 x 1 matrix
        ...
        # Vectorising only the pixel input data. Output data doesnt require processing.
...
def main():
    ...
    # Executing stochastic gradient descent on the training data set(train)
    # 30 is the number of iterations/epochs and 3.5 is the learning rate
    # After every iteration, the network will be tested against 'test',
    # displaying its accuracy over time.
    print("HL_count:", str(HL_count), "\tLearning rate: ", learning_rate)
    handwritingRecognizer.stochasticGradientDescent(trainData, testData, 30, learning_rate, batchSize)
